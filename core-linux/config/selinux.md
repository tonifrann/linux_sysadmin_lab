...
- Actualmente no aparece ningun bloqueo, ya que estamos en la configuración inicial. Cuando se configuren servicios como Samba o Nginx, si SELinux bloquea algo se documentará en [Bloqueos de SELinux](./incidents/selinux-block.md)
